...
Restaurant.create(name: "McDouble", address: "200 Glass Ave", capacity: 100, open_hour: Time.parse("12:30"), close_hour: Time.parse("23:00"))
Restaurant.create(name: "The Fancy Top Hat", address: "77 Caviar Pl", capacity: 20, open_hour: Time.parse("13:30"), close_hour: Time.parse("22:00"))
Restaurant.create(name: "Grill House", address: "8 Meat Heaven Lane", capacity: 100, open_hour: Time.parse("11:00"), close_hour: Time.parse("18:30"))
